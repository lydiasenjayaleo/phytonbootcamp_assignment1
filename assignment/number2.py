...
class Customer:
    ...
    def delete_account(self, account_name: str):
        ...
        if account_name in self.accounts:
            ...
            print ("Sorry, we cannot find your account")
...
class Bank:
    ...
    def delete_customer(self, name: str):
        ...
        if name in self.customers:
            ...
            print ("Thank you for being our customer, it was a pleasure serving you")
        else:
            print ("Sorry, you are not on our customer list")
